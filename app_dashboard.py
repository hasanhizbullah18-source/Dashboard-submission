...
if 'product_weight_g' in data.columns:
    ...
    if min_weight == max_weight:
        st.sidebar.info(f"Weight is uniform ({min_weight}g). Filter disabled.")
    else:
...
with tab2:
    ...
    if 'product_category_name_translated' in data.columns:
        ...
        # Count categories using translated names
        category_counts = data['product_category_name_translated'].value_counts().head(top_n)
        ...
        fig = px.bar(
            ...
            labels={'x': 'Product Count', 'index': 'Category'},
        ...
        with col1:
            most_common = data['product_category_name_translated'].value_counts().index[0]
            most_common_count = data['product_category_name_translated'].value_counts().values[0]
            st.info(f"**Most Products:** {most_common} ({most_common_count} products)")
        
        with col2:
            least_common = data['product_category_name_translated'].value_counts().index[-1]
            least_common_count = data['product_category_name_translated'].value_counts().values[-1]
